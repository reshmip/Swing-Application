 ...
 * @author Reshmi
 */
public class EditMemberJPanel extends javax.swing.JPanel {

    /**
     * Creates new form EditMemberJPanel
     */
    private JPanel userProcessContainer;
    private Member member;
    private Person person;
    public EditMemberJPanel(JPanel userProcessContainer,Member member,Person person) {
        initComponents();
    ...
    public void displayDetails(Member member){
        memNameTxt.setText(member.getMemberName());
        dobTxt.setText(String.valueOf(member.getAge()));
        relationsComboBox.setSelectedItem(member.getRelation());
    }
    ...
    private void initComponents() {
        ...
        saveMemerBtn = new javax.swing.JButton();
        ...
        saveMemerBtn.setBackground(new java.awt.Color(0, 153, 0));
        saveMemerBtn.setFont(new java.awt.Font("Verdana", 3, 12)); // NOI18N
        saveMemerBtn.setForeground(new java.awt.Color(255, 255, 255));
        saveMemerBtn.setText("Save");
        saveMemerBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                saveMemerBtnActionPerformed(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(saveMemerBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(saveMemerBtn)
                    .addComponent(backJButton))
                .addGap(30, 30, 30))
        );
    }// </editor-fold>//GEN-END:initComponents

    private void saveMemerBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveMemerBtnActionPerformed
        if(memNameTxt.getText().equals("")){
            JOptionPane.showMessageDialog(null, "Enter the member name", "Empty Field", JOptionPane.ERROR_MESSAGE);
        }
        else if(dobTxt.getText().equals("")){
            JOptionPane.showMessageDialog(null, "Enter the member age", "Empty Field", JOptionPane.ERROR_MESSAGE);
        }
        else{
            ...
            JOptionPane.showMessageDialog(null, "member edited successfully", "Edit Member", JOptionPane.INFORMATION_MESSAGE);
        }
    }//GEN-LAST:event_saveMemerBtnActionPerformed
    ...
    private javax.swing.JButton saveMemerBtn;
