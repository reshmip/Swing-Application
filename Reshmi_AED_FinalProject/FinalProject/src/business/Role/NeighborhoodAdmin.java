...
import userInterface.NeighborhoodAdmin.NeighborhoodAdminWorkAreaJPanel;

/**
 *
 * @author Reshmi
 */
public class NeighborhoodAdmin extends Role{
    ...
    public JPanel createWorkArea(JPanel container, UserAccount account, Organization org, Enterprise ent, EcoDistrict eco,Neighborhood areas) {
        return new NeighborhoodAdminWorkAreaJPanel(container, eco,areas,account,ent);
    }
